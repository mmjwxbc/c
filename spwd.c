 ...
 */
{
	...
	/* search for the name based on the specified inum */
 ...
 */
{
	...
	if (stat(fname, &info) == -1) /* we use stat instead of fstat cause you don't have a file descriptor and lstat is for links information */
	{
